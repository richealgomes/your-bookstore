...
import reader from '../Home/78813-student.json'
import { ShoppingCartIcon } from '@heroicons/react/24/solid'
import { Link } from 'react-router-dom'

const Home = () => {
  return (
    <div className='my-container flex flex-col items-center justify-between lg:flex-row lg:p-28 '>
      {/* Text Content */}
      <div className='mb-10 lg:max-w-lg  lg:pr-5 lg:mb-0'>
        <div className='max-w-xl mb-6 lg:mt-8 '>
          ...
          <h2 className='max-w-lg mb-6 font-sans text-4xl font-bold tracking-tight text-gray-900 sm:text-5xl sm:leading-none'>
            ...
            <span className=' text-yellow-500'> before he dies</span>
          </h2>
          <p className='text-xl text-gray-700 md:text-xl font-semibold '>
        ...
        <div className='flex flex-col items-center md:flex-row ml-10'>
          ...
          <Link
            to='/about'
            className='inline-flex items-center font-semibold text-gray-800 transition-colors duration-200 underline hover:text-yellow-500'
          >
            Learn More
          </Link>
        </div>
